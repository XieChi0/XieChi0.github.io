...
│                                                                     │
│  ┌─────────────────────────────────────────────────────────────┐   │
│  │ 第1步: 版本检查 (命令行参数 -v 或环境变量 WC_PRINT_VERSION) │   │
│  └─────────────────────────────────────────────────────────────┘   │
│  ┌─────────────────────────────────────────────────────────────┐   │
...
│      console.log(`WC listening on port: ${port}`)                │
...
|------|------|------|
| `id` | Int | 自增主键 |
| `dictName` | Varchar(100) | 字典名称 |
| `dictType` | Varchar(100) | 字典标识 |
| `dictStatus` | Char(1) | 状态 |
| `del` | Boolean | 软删除 |
| *...其他字段省略* | | |
