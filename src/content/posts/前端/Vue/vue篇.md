...
**子组件把childPassed传递给父组件，父组件把childPassed起名叫dataObj,可以输出{{dataObj.childPassed}}，或者是解构赋值<template #user="{childPassed}">来接收**
...
和上者一样，只不过对象在父组件命名的时候要使用`reactive`

![image-20241205162058059](./image-20241205162058059.png)



---

####  defineEmits子传父（defineEmits）
...
*父组件通过provide把数据传递给所有的子组件*

父组件

provide用于父组件传递给所有的子组件
...
https://www.dengruicode.com/classes_content?uuid=155d6469142a46b896af9f61d5d8f526
