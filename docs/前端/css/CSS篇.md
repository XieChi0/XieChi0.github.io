...
<img src="https://s1.imagehub.cc/images/2024/11/26/925b7de635e766a547201d09a25098c2.png" alt="image 20241025005726825" style="zoom:87%;" />
<img src="https://s1.imagehub.cc/images/2024/11/27/1b5c7f3e358cd203b68deed39c14a840.png" alt="image 20241025005737453" style="zoom:87%;" />
...
> 这里有很多前提，`text-align` 是给**父容器**设置的样式属性，影响**块级容器内的inline和inline-block    子元素**（例如文本、图片、按钮等）的水平对齐方式。
>
...
<img src="./assets/image-20250101144715591.png" alt="image-20250101144715591" style="zoom:80%;" />
